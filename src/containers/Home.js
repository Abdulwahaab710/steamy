    ...
    return (
      <div className='home-container'>
        <div className='home-inner'>
          ...
          <form className='home-container' action="http://localhost:3000/userLastPlayed/">
            <p className='home-subtitle centered'>- Step 1 -</p>
            <input className='home-input' type='text' name='username' placeholder='Enter your username' />
